export const METADATA = {
    HOME_TITLE: "Salon Unikatów – Antyki, Porcelana, Starocie, Rosenthal, Miśnia, Filiżanki",
    HOME_DESCRIPTION: "Salon Unikatów oferuje szeroki wybór staroci i antyków, w tym ręcznie malowaną porcelanę renomowanych manufaktur takich jak Rosenthal, Miśnia, czy Royal Doulton." ,
    ABOUT_TITLE: "O firmie | Salon Unikatów – Pasja do staroci i unikatów",
    ABOUT_DESCRIPTION: "Salon Unikatów to firma z Krakowa, specjalizująca się w sprzedaży antyków i porcelany. Poznaj naszą pasję i doświadczenie w dziedzinie unikatowych przedmiotów.",
